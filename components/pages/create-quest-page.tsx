...
export function CreateQuestPage({ player, setPlayer }: CreateQuestPageProps) {
  ...
  const handleSubmit = () => {
    ...
    const parsedXp = Number.parseInt(xp)
    const parsedTimeLimit = Number.parseInt(timeLimit)

    if (isNaN(parsedXp) || parsedXp <= 0 || isNaN(parsedTimeLimit) || parsedTimeLimit <= 0) {
      showNotification({
        title: "INVALID VALUES",
        message: "Please enter valid values for XP and time limit.",
        type: "warning",
      })
      return
    }
    ...
    const newQuest: Quest = {
      ...
      punishment,
      completed: false,
      muscleGroups: selectedMuscleGroups.length > 0 ? (selectedMuscleGroups as any[]) : undefined,
    }
          ...
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
              <div className="flex items-center space-x-2 bg-black/40 p-2 rounded-none cursor-pointer hover:bg-black/60">
                <Checkbox
                  id="muscle-chest"
                  checked={selectedMuscleGroups.includes("chest")}
              ...
              <div className="flex items-center space-x-2 bg-black/40 p-2 rounded-none cursor-pointer hover:bg-black/60">
                <Checkbox
                  id="muscle-back"
                  checked={selectedMuscleGroups.includes("back")}
              ...
              <div className="flex items-center space-x-2 bg-black/40 p-2 rounded-none cursor-pointer hover:bg-black/60">
                <Checkbox
                  id="muscle-shoulders"
                  checked={selectedMuscleGroups.includes("shoulders")}
              ...
              <div className="flex items-center space-x-2 bg-black/40 p-2 rounded-none cursor-pointer hover:bg-black/60">
                <Checkbox
                  id="muscle-arms"
                  checked={selectedMuscleGroups.includes("arms")}
              ...
              <div className="flex items-center space-x-2 bg-black/40 p-2 rounded-none cursor-pointer hover:bg-black/60">
                <Checkbox
                  id="muscle-abs"
                  checked={selectedMuscleGroups.includes("abs")}
              ...
              <div className="flex items-center space-x-2 bg-black/40 p-2 rounded-none cursor-pointer hover:bg-black/60">
                <Checkbox
                  id="muscle-legs"
                  checked={selectedMuscleGroups.includes("legs")}
